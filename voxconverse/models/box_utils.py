...
def nms(boxes: torch.Tensor, scores: torch.Tensor, overlap: float = 0.5, top_k: int = 200) -> Tuple[torch.Tensor, int]:
...
class PriorBox(object):
    def __init__(self,
                 ...
                 variance: List[float] = [0.1, 0.2],
                 min_sizes: List[int] = [16, 32, 64, 128, 256, 512],
                 steps: List[int] = [4, 8, 16, 32, 64, 128],
